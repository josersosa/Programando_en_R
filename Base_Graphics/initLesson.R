...
marital<-matrix(c(652,1537,598,242,36,46,38,21,218,327,106,67),nrow = 3, byrow = T)
colnames(marital)<-c("0","1-150","151-300",">300")
rownames(marital)<-c("Married","Prev.Married","Single")